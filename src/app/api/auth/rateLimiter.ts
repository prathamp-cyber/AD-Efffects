...
export const RATE_LIMITS = {
  ...
  configUpdate: { maxAttempts: 5000, windowMs: 5 * 60 * 1000, endpoint: 'config' } as RateLimitConfig,
  upload: { maxAttempts: 5000, windowMs: 5 * 60 * 1000, endpoint: 'upload' } as RateLimitConfig,
};
