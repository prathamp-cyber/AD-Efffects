    ...
    >
      ...
      >
        <button 
          ...
          className="brand-logo text-[44px] md:text-[56px] text-primary leading-none focus:outline-none cursor-pointer hover:opacity-75 transition-opacity tracking-[0.18em] font-medium"
        >
          THE AD EFFFECT
        </button>
        <span className="text-[10px] uppercase tracking-[0.3em] text-primary mt-2.5 font-sans font-medium">Form Follows Function</span>
      ...
      <div className="text-[9px] tracking-[0.35em] text-secondary/50 font-light text-center uppercase px-6">
        <span className="mr-[-0.35em]">
          <span>COPYRIGHT {currentYear} </span>
           <span className="normal-case font-medium text-primary">THE AD EFFFECT</span>
